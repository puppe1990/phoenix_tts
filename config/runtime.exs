...
#
#     PHX_SERVER=true bin/phoenix_tts start
#
...
config :phoenix_tts,
  ...
  elevenlabs_synthesis_receive_timeout:
    String.to_integer(System.get_env("ELEVENLABS_SYNTHESIS_RECEIVE_TIMEOUT", "180000")),
...
if config_env() == :prod do
  ...
  config :phoenix_tts, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :phoenix_tts, PhoenixTts.Mailer,
